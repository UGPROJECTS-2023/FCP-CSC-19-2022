...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		//"`class_time_table`.`course`" => "course",
	...
	$x->TableTitle = "FEDERAL UNIVERSITY DUTSE CLASS TIMETABLE";
	...
	$x->ColCaption = array("Day", " Time Start", "Time End", "course", "Unit code", "Venue", "Department", "Level");
