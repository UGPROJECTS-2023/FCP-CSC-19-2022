...
<head>
  ...
  <title>Automated Time Table Generator for University couses</title>
  <!-- Bootstrap core CSS-->
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.html">AUTOMATED TIMETABLE GENERATION FOR OPTIMAZED SCHEDULING OF UNIVERSITY COURSES</a>
    ...
    <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small>Copyright © `Automated Time Table Generator for University courses 2023</small>
        </div>
      </div>
    </footer>
